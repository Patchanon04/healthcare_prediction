<template>
  <div class="min-h-screen bg-gradient-to-br from-[#00838F] via-[#4DD0E1] to-white flex">
    ...
    <aside class="w-64 bg-gradient-to-b from-[#006064] to-[#00838F] shadow-lg flex flex-col hidden md:flex">
      ...
      <!-- Navigation -->
      <nav class="flex-1 p-4 space-y-3 pr-0">
        <router-link 
          to="/dashboard" 
          class="block px-6 py-3 rounded-r-full hover:bg-white/10 transition text-[#00BCD4] bg-white border-2 border-transparent"
        ...
        <button 
          type="button"
          @click="confirmLogout"
          class="block w-full text-left px-6 py-3 rounded-r-full hover:bg-white/10 transition text-[#00BCD4] bg-white border-2 border-transparent"
        >
